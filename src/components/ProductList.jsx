    ...
    <div className="mt-4">
      <div className="flex justify-between items-center">
        ...
        <Link
          ...
          type="button"
          className="text-white flex items-center gap-1 justify-center bg-stone-700 hover:bg-stone-800 focus:ring-4 focus:ring-stone-300 font-medium rounded-lg text-sm px-5 py-4 md:px-5 md:py-2.5 me-2 mb-2 dark:bg-stone-600 dark:hover:bg-stone-700 focus:outline-none dark:focus:ring-stone-800"
        >
          <span className="md:block hidden">Add New Product</span>
